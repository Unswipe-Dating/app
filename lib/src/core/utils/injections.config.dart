...
import '../../features/login/domain/usecases/update_login_state_stream_usecase.dart'
    as _i15;
import '../../features/login/domain/usecases/verify_otp_use_case.dart' as _i12;
...
import '../../features/onBoarding/domain/usecases/update_onboarding_state_stream_usecase.dart'
    as _i18;
import '../../shared/data/repository/user_repository_imp.dart' as _i14;
import '../../shared/domain/repository/user_repository.dart' as _i13;
...
import 'usecases/usecase_module.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initGetIt({
    ...
    gh.factory<_i12.VerifyOtpUseCase>(
        () => _i12.VerifyOtpUseCase(gh<_i9.LoginRepository>()));
    gh.factory<_i13.UserRepository>(
        () => _i14.UserRepositoryImpl(gh<_i5.LocalDataSource>()));
    gh.factory<_i15.UpdateUserStateStreamUseCase>(
        () => _i15.UpdateUserStateStreamUseCase(gh<_i13.UserRepository>()));
    gh.factory<_i16.GetAuthStateStreamUseCase>(
        () => _i16.GetAuthStateStreamUseCase(gh<_i13.UserRepository>()));
    gh.factory<_i17.GetOnboardingStateStreamUseCase>(
        () => _i17.GetOnboardingStateStreamUseCase(gh<_i13.UserRepository>()));
    gh.factory<_i18.UpdateOnboardingStateStreamUseCase>(() =>
        _i18.UpdateOnboardingStateStreamUseCase(gh<_i13.UserRepository>()));
    return this;
  }
}
