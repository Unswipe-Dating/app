...
import '../../features/login/domain/usecases/request_otp_use_case.dart' as _i34;
import '../../features/login/domain/usecases/signup_login_usecase.dart' as _i35;
import '../../features/login/domain/usecases/update_login_state_stream_usecase.dart'
    as _i31;
import '../../features/login/domain/usecases/verify_otp_use_case.dart' as _i36;
...
import '../../features/userProfile/domain/usecase/profile_get_usecase.dart'
    as _i28;
import '../../shared/data/repository/user_repository_imp.dart' as _i30;
import '../../shared/domain/repository/user_repository.dart' as _i29;
...
import 'usecases/usecase_module.dart' as _i41;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initGetIt({
    ...
    gh.factory<_i28.ProfileGetUseCase>(
        () => _i28.ProfileGetUseCase(gh<_i16.ProfileSwipeRepository>()));
    gh.factory<_i29.UserRepository>(
        () => _i30.UserRepositoryImpl(gh<_i5.LocalDataSource>()));
    gh.factory<_i31.UpdateUserStateStreamUseCase>(
        () => _i31.UpdateUserStateStreamUseCase(gh<_i29.UserRepository>()));
    gh.factory<_i32.GetAuthStateStreamUseCase>(
        () => _i32.GetAuthStateStreamUseCase(gh<_i29.UserRepository>()));
    gh.factory<_i33.ContactBlockUseCase>(
        () => _i33.ContactBlockUseCase(gh<_i23.ContactBlockRepository>()));
    gh.factory<_i34.RequestOtpUseCase>(
        () => _i34.RequestOtpUseCase(gh<_i26.LoginRepository>()));
    gh.factory<_i35.SignUpUseCase>(
        () => _i35.SignUpUseCase(gh<_i26.LoginRepository>()));
    gh.factory<_i36.VerifyOtpUseCase>(
        () => _i36.VerifyOtpUseCase(gh<_i26.LoginRepository>()));
    gh.factory<_i37.GetOnboardingStateStreamUseCase>(
        () => _i37.GetOnboardingStateStreamUseCase(gh<_i29.UserRepository>()));
    gh.factory<_i38.UpdateOnboardingStateStreamUseCase>(() =>
        _i38.UpdateOnboardingStateStreamUseCase(gh<_i29.UserRepository>()));
    gh.factory<_i39.CreateProfileUseCase>(
        () => _i39.CreateProfileUseCase(gh<_i21.UpdateProfileRepository>()));
    gh.factory<_i40.UpdateProfileUseCase>(
        () => _i40.UpdateProfileUseCase(gh<_i21.UpdateProfileRepository>()));
    return this;
  }
}
