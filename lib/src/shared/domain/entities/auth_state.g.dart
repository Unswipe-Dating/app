...
class AuthenticatedStateBuilder
  ...
  UserAndTokenEntityBuilder? _userAndToken;
  UserAndTokenEntityBuilder get userAndToken =>
      _$this._userAndToken ??= new UserAndTokenEntityBuilder();
  set userAndToken(UserAndTokenEntityBuilder? userAndToken) =>
